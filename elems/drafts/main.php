<!-- 36 symbols for title and for author -->
<main id="main_posts">
    <ul class="cards_list">
      <?php
    ...
    <ul class="pages_list">
      <?php
        $countOfPages = getCountOfPages(getCountOfUserPosts($dbh, $login) + 1, $POSTS_PER_PAGE);
